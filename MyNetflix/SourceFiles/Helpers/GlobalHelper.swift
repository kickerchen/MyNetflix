...
let episode1 = Episode(name: "Beginnings and Endings",
                       ...
                       description: "Six months after the disappearances, the police form a task force. In 2052, [sic] Jonas learns that most of Winden perished in an apocalyptic event.",
                       length: 53,
